...
//    }
    ...
    @Override
    public boolean hasAccess(Permissible target, String userId, String creator, String permission) throws ServerException {
        ...
        final Permissions permissions = target.getPermissions();
        if (permissions == null) {
            return false;
        }
