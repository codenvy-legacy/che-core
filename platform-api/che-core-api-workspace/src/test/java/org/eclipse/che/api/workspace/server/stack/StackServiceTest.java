...
public class StackServiceTest {
    ...
    private DecoratedStackImpl   stackImpl;
    ...
    public void setUp() throws IOException, ConflictException {
        ...
        stackImpl = DecoratedStackImpl.builder().setId(ID_TEST)
                                      .setName(NAME)
    ...
    public void newStackShouldBeCreated() throws ConflictException, ServerException {
        ...
        verify(stackDao).create(any(DecoratedStackImpl.class));
    ...
    public void stackByIdShouldBeReturned() throws NotFoundException, ServerException {
        when(checker.hasAccess(any(DecoratedStackImpl.class), eq(CREATOR), eq(stackImpl.getCreator()), eq("read"))).thenReturn(true);
        ...
        verify(checker).hasAccess(any(DecoratedStackImpl.class), eq(CREATOR), eq(stackImpl.getCreator()), eq("read"));
    }

    @Test
    public void shouldThrowForbiddenExceptionWhenWeTryToGetForeignStack() throws NotFoundException, ServerException {
        DecoratedStackImpl foreignStack = DecoratedStackImpl.builder()
                                                            .setId(ID_TEST)
                                                            .setName(NAME)
                                                            .setDescription(DESCRIPTION)
                                                            .setScope(SCOPE)
    ...
    public void shouldThrowForbiddenExceptionWhenUserTryUpdatePredefinedStack()
        ...
        DecoratedStackImpl updatedStack = DecoratedStackImpl.builder().setId(ID_TEST)
    ...
    public void StackShouldBeUpdated() throws NotFoundException, ServerException, ConflictException {
        ...
        DecoratedStackImpl updateStack = new DecoratedStackImpl(stackImpl, stackImpl.getIcon());
        updateStack.setDescription(updatedDescription);
        updateStack.setScope(updatedScope);

        when(checker.hasAccess(any(DecoratedStackImpl.class), anyString(), eq(stackImpl.getCreator()), eq("write"))).thenReturn(true);
        ...
        verify(checker).hasAccess(any(DecoratedStackImpl.class), anyString(), eq(updatedStackDto.getCreator()), eq("write"));
    }
    ...
    public void creatorShouldNotBeUpdated() throws ServerException, NotFoundException {
        ...
        verify(stackDao).update(any());
        verify(stackDao, times(2)).getById(ID_TEST);
        verify(checker).hasAccess(any(DecoratedStackImpl.class), anyString(), eq(stackImpl.getCreator()), eq("write"));
    }
    ...
    public void shouldThrowForbiddenExceptionWhenWeTryDeleteAlienStack() throws NotFoundException, ServerException {
        DecoratedStackImpl stack = DecoratedStackImpl.builder()
                                                     .setId(ID_TEST)
                                                     .setName(NAME)
                                                     .setDescription(DESCRIPTION)
                                                     .setScope(SCOPE)
