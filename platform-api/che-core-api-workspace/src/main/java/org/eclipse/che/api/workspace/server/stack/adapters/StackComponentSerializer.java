...
/**
 * Custom implementation of deserialize StackComponent objects
 *
 * @author Alexander Andrienko
 */
public class StackComponentSerializer implements JsonSerializer<StackComponent>, JsonDeserializer<StackComponent> {
