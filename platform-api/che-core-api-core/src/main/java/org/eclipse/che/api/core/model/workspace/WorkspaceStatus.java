...
public enum WorkspaceStatus {
    ...
    /**
     * Workspace considered as starting only and only if its dev-machine is booting(creating).
     *
     * <p>Workspace becomes running only if it was {@link #STOPPED}.
     * The status map:
     * <pre>
    ...
    /**
     * Workspace considered as running only and only if its dev-machine was successfully started and it is running.
     *
    ...
    /**
     * Workspace considered as stopping only and only if its dev-machine is shutting down(destroying).
     *
     * <p>Workspace is in stopping status only if it was in {@link #RUNNING} status before.
     * The status map:
     * <pre>
     *  RUNNING -> <b>STOPPING</b> -> STOPPED (normal behaviour)/(failed to stop)
     * </pre>
     *
     ...
     * <li>Dev-machine failed to stop</li>
     ...
     * <p>The status map:
     * <pre>
     *  STOPPING -> <b>STOPPED</b> (normal behaviour)/(failed to stop)
