...
/**
 * Jgit implementation of {@link MergeResult}
 *
 * @author Andrey Parfonov
 */
class JGitMergeResult implements MergeResult {
     ...
     *         back-end instance
     */
    JGitMergeResult(org.eclipse.jgit.api.MergeResult jgitMergeResult) {
    ...
    public List<String> getConflicts() {
        ...
        if (conflicts != null) {
            files = new ArrayList<>(conflicts.size());
    ...
    public List<String> getFailed() {
        ...
        if (failing != null) {
            files = new ArrayList<>(failing.keySet());
        }
        return files;
    }
