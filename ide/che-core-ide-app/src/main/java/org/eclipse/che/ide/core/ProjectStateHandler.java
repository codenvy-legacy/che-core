...
public class ProjectStateHandler implements Component, OpenProjectHandler, CloseCurrentProjectHandler, /*ProjectDescriptorChangedHandler,*/
    ...
    private final ProjectProblemResolver   projectProblemResolver;
    ...
    public ProjectStateHandler(AppContext appContext,
                               EventBus eventBus,
                               ProjectProblemResolver projectProblemResolver,
        ...
        this.projectProblemResolver = projectProblemResolver;
                    ...
                    if (appContext.getCurrentProject() != null) {
                        closeCurrentProject(new CloseCallback() {
                            ...
                            public void onClosed() {
                                projectProblemResolver.resolve(project);
                            }
                        }, false);
                    } else {
                        projectProblemResolver.resolve(project);
