...
public class StandardComponentInitializer {
    ...
    public void initialize() {
        ...
        actionManager.registerAction("switchLeftTabAction", switchLeftTabAction);
        actionManager.registerAction("switchRightTabAction", switchRightTabAction);
        ...
        keyBinding.getGlobal().addKey(new KeyBuilder().alt().charCode(KeyCodeMap.ARROW_LEFT).build(), "switchLeftTabAction");
        keyBinding.getGlobal().addKey(new KeyBuilder().alt().charCode(KeyCodeMap.ARROW_RIGHT).build(), "switchRightTabAction");
    }
