...
public class FileNodeTest extends BaseNodeTest {
    ...
    private static final String expectedPath = "/project/folderRenamed/file_name";
    private static final String renamedParentPath = "/project/folderRenamed";
    ...
    public void dataShouldBeUpdated() {
        ...
        fileNode.updateData(asyncCallback, renamedParentPath);

        verify(projectServiceClient).getItem(eq(expectedPath), itemArgumentCaptor.capture());
        GwtReflectionUtils.callOnSuccess(itemArgumentCaptor.getValue(), result);
